...
public class EventDefine {
    ...
    public struct OnJump : IEventParam { }
    public struct OnSpeedBoosterActivatedEvent : IEventParam { public float SpeedUpPercent; }
    public struct OnStrengthBoosterActivatedEvent : IEventParam { public float StrengthUpPercent; }
    public struct OnMagicStepBoosterActivatedEvent : IEventParam {}
    public struct OnShieldBoosterActivatedEvent : IEventParam { public bool IsAvalible; }
    ...
    public struct OnUpdateCountTime : IEventParam { public int CurrentTime; }

    public struct OnGlassBreak : IEventParam { public GameObject GO; }

    public struct OnBombExplode : IEventParam { }

    public struct OnUpdateWarningRLGL : IEventParam { }
    public struct OnLightStatusChangeRLGL : IEventParam { public bool IsGreenLight; }
    public struct OnUpdateMarbleScore : IEventParam { public bool IsPlayerMarble; public bool IsWin; }
    public struct OnFinishMarbleTurn : IEventParam { }

    public struct OnFruitMerge : IEventParam {
